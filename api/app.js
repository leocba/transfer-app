...
app.get('/api/transactions', (req, res) => {
  return res.json({
    list: [
      { id: '1fee3cde-a656-4f9b-9bac-a4dd5008f4fa', accountHolder: 'Penelope Berry', IBAN: 'DE63500105173833675741', amount: 10.99, date: new Date('2021-06-12'), note: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.'},
      ...
      { id: 'f51d52c3-4d86-448e-8e0d-0ae23703c9cc', accountHolder: 'David Butler', IBAN: 'DE82500105171946297899', amount: 1000.99, date: new Date('2021-06-13'), note: 'Mauris egestas sagittis nunc eu condimentum.'},
